...
export const AURORA_CITY_MAP: CityMapConfig = {
  ...
  hotspots: [
...

    {
      ...
      encounterTable: [
        { speciesKey: "moineau", minLevel: 1, maxLevel: 2, rarityWeight: 40, captureRate: 0.5 },
        { speciesKey: "ecureuil", minLevel: 1, maxLevel: 2, rarityWeight: 35, captureRate: 0.45 },
        { speciesKey: "lierre", minLevel: 1, maxLevel: 2, rarityWeight: 15, captureRate: 0.45 },
        { speciesKey: "scarabee", minLevel: 1, maxLevel: 2, rarityWeight: 10, captureRate: 0.32 },
        { speciesKey: "grenouille", minLevel: 1, maxLevel: 2, rarityWeight: 8, captureRate: 0.42 },
        { speciesKey: "loutre", minLevel: 1, maxLevel: 2, rarityWeight: 5, captureRate: 0.4 },
      ],
    ...
    },
    {
      ...
      encounterTable: [
        { speciesKey: "lierre", minLevel: 3, maxLevel: 5, rarityWeight: 40, captureRate: 0.45 },
        { speciesKey: "scarabee", minLevel: 3, maxLevel: 5, rarityWeight: 30, captureRate: 0.32 },
        { speciesKey: "moineau", minLevel: 3, maxLevel: 5, rarityWeight: 15, captureRate: 0.5 },
        { speciesKey: "ecureuil", minLevel: 3, maxLevel: 5, rarityWeight: 10, captureRate: 0.45 },
        { speciesKey: "salamandre", minLevel: 3, maxLevel: 5, rarityWeight: 8, captureRate: 0.35 },
        { speciesKey: "renardeau", minLevel: 3, maxLevel: 5, rarityWeight: 5, captureRate: 0.3 },
      ],
    ...
    },
    {
      ...
      elementalType: "normal",
      encounterTable: [
        { speciesKey: "moineau", minLevel: 6, maxLevel: 9, rarityWeight: 12000, captureRate: 0.5 },
        { speciesKey: "ecureuil", minLevel: 6, maxLevel: 9, rarityWeight: 8000, captureRate: 0.45 },
        { speciesKey: "lierre", minLevel: 6, maxLevel: 9, rarityWeight: 3000, captureRate: 0.45 },
        { speciesKey: "grenouille", minLevel: 6, maxLevel: 9, rarityWeight: 1500, captureRate: 0.42 },
        { speciesKey: "renardeau", minLevel: 6, maxLevel: 9, rarityWeight: 499, captureRate: 0.3 },
        // Ultra-rare: exactly 1/25000 (1 / (12000+8000+3000+1500+499+1)).
    ...
    },
    {
      ...
      elementalType: "eau",
      encounterTable: [
        { speciesKey: "grenouille", minLevel: 10, maxLevel: 14, rarityWeight: 40, captureRate: 0.42 },
        { speciesKey: "loutre", minLevel: 10, maxLevel: 14, rarityWeight: 32, captureRate: 0.4 },
        { speciesKey: "moineau", minLevel: 10, maxLevel: 14, rarityWeight: 15, captureRate: 0.5 },
        { speciesKey: "ecureuil", minLevel: 10, maxLevel: 14, rarityWeight: 10, captureRate: 0.45 },
        { speciesKey: "moucheron-foudre", minLevel: 10, maxLevel: 14, rarityWeight: 8, captureRate: 0.25 },
        { speciesKey: "goupil-etincelle", minLevel: 10, maxLevel: 14, rarityWeight: 5, captureRate: 0.2 },
      ],
    ...
    },
    {
      ...
      elementalType: "feu",
      encounterTable: [
        { speciesKey: "salamandre", minLevel: 25, maxLevel: 30, rarityWeight: 35, captureRate: 0.35 },
        { speciesKey: "renardeau", minLevel: 25, maxLevel: 30, rarityWeight: 28, captureRate: 0.3 },
        { speciesKey: "moucheron-foudre", minLevel: 25, maxLevel: 30, rarityWeight: 15, captureRate: 0.25 },
        { speciesKey: "goupil-etincelle", minLevel: 25, maxLevel: 30, rarityWeight: 12, captureRate: 0.2 },
        { speciesKey: "loutre", minLevel: 25, maxLevel: 30, rarityWeight: 6, captureRate: 0.4 },
        { speciesKey: "scarabee", minLevel: 25, maxLevel: 30, rarityWeight: 4, captureRate: 0.32 },
      ],
    ...
    },
    {
      ...
      elementalType: "electrique",
      encounterTable: [
        { speciesKey: "moucheron-foudre", minLevel: 32, maxLevel: 36, rarityWeight: 30, captureRate: 0.25 },
        { speciesKey: "goupil-etincelle", minLevel: 32, maxLevel: 36, rarityWeight: 25, captureRate: 0.2 },
        { speciesKey: "salamandre", minLevel: 32, maxLevel: 36, rarityWeight: 15, captureRate: 0.35 },
        { speciesKey: "renardeau", minLevel: 32, maxLevel: 36, rarityWeight: 12, captureRate: 0.3 },
        { speciesKey: "grenouille", minLevel: 32, maxLevel: 36, rarityWeight: 10, captureRate: 0.42 },
        { speciesKey: "lierre", minLevel: 32, maxLevel: 36, rarityWeight: 8, captureRate: 0.45 },
      ],
